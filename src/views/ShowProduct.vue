<template>
  <div class="container my-5">
    <h2 class="text-center mb-4">Show Product</h2>
    <div class="row">
      <div class="col-md-4" v-for="product in products" :key="product.product_id">
        <div class="card shadow-sm mb-4">
          ...
          <div class="card-body text-center">
            ...
            <p class="card-text">{{ product.price }} Bath</p>
            <p class="card-text">Remain {{ product.stock }} </p>
  ...
  setup() {
    ...
    const fetchProducts = async () => {
      try {
        ...
        const response = await fetch("http://localhost/67713669/api_php/show_product.php", {
          method: "GET",
          headers: {
